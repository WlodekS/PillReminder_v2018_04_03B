...
/**
 * Created by PillRemonderGroup on 2018-04-19.
 * Adapter do ładowania danych do widoku Medicines w raporcie
 */
...
/**
 * MedicineAdapter_StoreList
 */

public class MedicineAdapter_StoreList extends BaseAdapter {
    Context mContex;
    ArrayList<Medicine> mMedicines;
    LayoutInflater mInflater;

    public MedicineAdapter_StoreList(Context c, ArrayList<Medicine> medicines) {
        this.mContex = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = mInflater.inflate(R.layout.item_store_report, null);
        ...
        TextView textViewComment = (TextView)view.findViewById(R.id.tv_rs_Comment);
        ...
        //Decide:comment for medicine quantity:
        if(currentMedicine.getQuantity() < 10){
            textViewComment.setText("Buy It!");
            textViewComment.setTextColor(ContextCompat.getColor(mContex, R.color.colorListView_Report_BuyIt));
        }else{
            textViewComment.setText("OK!");
            textViewComment.setTextColor(ContextCompat.getColor(mContex, R.color.colorListView_Report_OK));
        }
